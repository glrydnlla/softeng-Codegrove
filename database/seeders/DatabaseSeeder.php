...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('posts')->insert([
            ['user_id' => 1, 'programming_language_id' => 1, 'post_id' => NULL, 'post_content' => 'Explain the difference between int and float data types in C.', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(180)],
            ['user_id' => 1, 'programming_language_id' => 1, 'post_id' => NULL, 'post_content' => 'What is the purpose of the main function in a C program?', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(170)],
            ['user_id' => 1, 'programming_language_id' => 1, 'post_id' => NULL, 'post_content' => 'How do you declare and define a function in C?', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(160)],
            ['user_id' => 1, 'programming_language_id' => 1, 'post_id' => NULL, 'post_content' => 'Explain the difference between call by value and call by reference in C functions.', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(150)],
            ['user_id' => 1, 'programming_language_id' => 1, 'post_id' => NULL, 'post_content' => 'What is a pointer in C? How do you declare and use pointers?', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(140)],
            ['user_id' => 1, 'programming_language_id' => 1, 'post_id' => NULL, 'post_content' => 'What is the malloc function in C? How is it used for dynamic memory allocation?', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(130)],
            ['user_id' => 1, 'programming_language_id' => 1, 'post_id' => NULL, 'post_content' => 'Explain the concept of arrays in C. How do you declare and access elements of an array?', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(120)],
            ['user_id' => 1, 'programming_language_id' => 1, 'post_id' => NULL, 'post_content' => 'Describe the difference between printf and scanf functions in C.', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(110)],
            ['user_id' => 1, 'programming_language_id' => 1, 'post_id' => NULL, 'post_content' => 'What are conditional statements in C? Provide examples of if, if-else, and switch statements.', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(100)],
            ['user_id' => 2, 'programming_language_id' => 1, 'post_id' => 1, 'post_content' => 'In C, the int data type is used for integers, representing whole numbers, while the float data type is used for floating-point numbers, representing numbers with decimal points.', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(90)],
            ['user_id' => 2, 'programming_language_id' => 1, 'post_id' => 2, 'post_content' => 'The main function serves as the entry point for a C program, where program execution begins. It typically contains the code that performs the primary functionality of the program.', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(80)],
            ...
            ['user_id' => 2, 'programming_language_id' => 1, 'post_id' => 5, 'post_content' => 'In C, a pointer is a variable that stores the memory address of another variable. Pointers are widely used for dynamic memory allocation, accessing array elements, and implementing data structures like linked lists and trees.', 'status' => 'active', 'created_at' => Carbon::now()->subSeconds(50)],
